...
import { getDemoEmail, getDemoPassword } from '@/shared/utils/envHelpers';
...
export default function LoginPage() {
  ...
  const { formData, errors, touched, handleChange, handleBlur, handleValidate } =
      ...
      <main className="login-container">
        <div className="login-card">
          ...
          <p className="register-link">
            {t('authPage.login.noAccount')} <a href="/register">{t('authPage.login.signup')}</a>
          </p>
        </div>
      </main>
    </div>
