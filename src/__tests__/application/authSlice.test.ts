...
import authSlice, { logout, setUser, setToken, restoreAuth, login, register } from "@/application/store/slices/authSlice";
...
describe("authSlice", () => {
  ...
  describe("register async thunk", () => {
    it("should handle register.pending", () => {
      const action = register.pending("", { firstName: "Test", lastName: "User", email: "test@example.com", password: "password" });
    ...
    it("should handle register.rejected", () => {
      const action = register.rejected(new Error("Registration error"), "", { firstName: "Test", lastName: "User", email: "test@example.com", password: "password" }, "Registration error");
